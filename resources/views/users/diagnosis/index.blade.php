                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <label class="checkbox checkbox-outline-primary">
                                        <input type="checkbox" id="symptom_{{ $symtom->id }}"
                                            name="symptoms[{{ $symtom->id }}]" value="{{ $symtom->id }}" />
                                        <span class="fw-bold fs-6">{{ $symtom->symptom }}</span>
                                ...
                                <div id="cf_user_{{ $symtom->id }}" class="cf-options mt-3 fs-6 text-left"
                                    style="display: none;">
                                    <p class="fw-bold mx-1 mb-2 fs-6">Tingkat keyakinan Anda?
                                    </p>
                                    <label class="ml-3">
                                        <input type="radio" name="cf_user[{{ $symtom->id }}]" value="1.0"> Pasti
                                    </label><br>
                                    <label class="ml-3">
                                        <input type="radio" name="cf_user[{{ $symtom->id }}]" value="0.8"> Hampir
                                        pasti
                                    </label><br>
                                    <label class="ml-3">
                                        <input type="radio" name="cf_user[{{ $symtom->id }}]" value="0.6">
                                        Kemungkinan besar
                                    </label><br>
                                    <label class="ml-3">
                                        <input type="radio" name="cf_user[{{ $symtom->id }}]" value="0.4"> Mungkin
                                    </label><br>
                                    <label class="ml-3">
                                        <input type="radio" name="cf_user[{{ $symtom->id }}]" value="0"> Tidak
                                        tahu
                                    </label><br>
                                    <label class="ml-3">
                                        <input type="radio" name="cf_user[{{ $symtom->id }}]" value="-0.4"> Mungkin
