        ...
        <div class="outer-container">
            <div class="header-upper clearfix">
                ...
                <div class="menu-right-content pull-right">
                    <div class="phone">Call Us <a href="tel:880762009">+62 821 7973 6858</a></div>
                    @guest
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            ...
            <div class="contact-info">
                <h4>Contact Info</h4>
                <ul>
                    <li>Lhokseumawe, Aceh Indonesia</li>
                    <li><a href="tel:+8801682648101">+62 821 7973 6858</a></li>
                    <li><a href="mailto:bagas@bagason.com">bagas@bagason.com</a></li>
                </ul>
            </div>
        </nav>
    </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget contact-widget">
                                ...
                                <ul class="social-links clearfix">
                                    <li><a href="https://web.facebook.com/BagasAuliaAlfasyam"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="https://twitter.com/bagasaulia1"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="http://instagram.com/___agas_"><i class="fab fa-instagram"></i></a></li>
                                    <li><a href="http://bagason.site/"><i class="fab fa-internet-explorer"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
